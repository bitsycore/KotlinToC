...
private fun buildCmakeLists(
	...
	// ── Module dependencies ──────────────────────────────────────────────
	if (inHasModules) {
		appendLine("# ── Module dependencies (from module.ktc.toml / --module flags) ───────────")
		appendLine("# Generated by the transpiler — re-run to refresh.")
		appendLine("include(\"\${CMAKE_CURRENT_SOURCE_DIR}/ktc_modules.cmake\")")
		appendLine()
		}

	// ── User hook ────────────────────────────────────────────────────────
	appendLine("# ── User customizations ──────────────────────────────────────────────────")
